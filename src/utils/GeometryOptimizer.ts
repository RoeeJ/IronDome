...
export class GeometryOptimizer {
   ...
   */
  static simplifyGeometry(geometry: THREE.BufferGeometry, targetRatio: number = 0.1): THREE.BufferGeometry {
   ...
   */
  static createLODFromModel(object: THREE.Object3D, levels: number[] = [1.0, 0.5, 0.2, 0.1]): THREE.LOD {
