    ...
    if (object.geometry && object.userData.originalGeometry) {
      switch (level) {
        ...
        case 1: // Medium detail
          object.geometry = this.simplifyGeometry(object.userData.originalGeometry, 0.7);
          break;
        case 2: // Low detail
          object.geometry = this.simplifyGeometry(object.userData.originalGeometry, 0.4);
          break;
        case 3: // Very low detail
          object.geometry = this.simplifyGeometry(object.userData.originalGeometry, 0.2);
          break;
      }
    }
  }
